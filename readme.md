...
Shown is an example of how sine and cosine have the same e-complexity while random data is much different. (See how blue's the basal error is increased?) All that is left is parameterizing the curves to crate a parameter hyperspace for your timeseries/timeseries-like data. 
...
3) Cython routines for speedy sampling code.
